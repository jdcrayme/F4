...
public:
    ...
    /// (Raw pointers are used instead of std::reference_wrapper because the
    /// default-construct-then-reassign pattern in FlightModel::initSubsystems
    /// requires a null intermediate state.)
