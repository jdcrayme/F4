...
/// Helper to build AeroInputs from positional parameters (mirrors the old API).
AeroInputs makeAeroIn(Angle alpha, Angle beta,
                      double mach, double vt_ftps,
                      double qbar, double qsom,
                      double altitude_ft, double groundZ_ft,
                      double z_ft, double vcas_kts,
                      double pstick) {
    AeroInputs in;
    in.alpha      = alpha;
    in.beta       = beta;
    ...
    in.qbar       = qbar;
    in.qsom       = qsom;
    in.altitude_ft = altitude_ft;
    in.groundZ_ft = groundZ_ft;
    in.z_ft       = z_ft;
...
TEST(Aerodynamics, ClAtGridPointMach0Alpha0) {
    ...
    a.update(makeAeroIn(angle_from_degrees(0.0), angle_from_degrees(0.0), /*mach=*/0.0, /*vt=*/100.0,
...
TEST(Aerodynamics, ClAtGridPointMach0Alpha10) {
    ...
    Aerodynamics a(&sa.table, &sa.geom, &sa.aux);
    AeroState s = makeAero();
    a.update(makeAeroIn(angle_from_degrees(10.0), angle_from_degrees(0.0), 0.0, 100.0, 1.0, 1.0, 1000.0, 0.0, -1000.0, 100.0, 0.0), s);
...
TEST(Aerodynamics, ClAtMidpointMachHalfAlphaHalf) {
    ...
    Aerodynamics a(&sa.table, &sa.geom, &sa.aux);
    AeroState s = makeAero();
    a.update(makeAeroIn(angle_from_degrees(5.0), angle_from_degrees(0.0), 0.5, 100.0, 1.0, 1.0, 1000.0, 0.0, -1000.0, 100.0, 0.0), s);
...
TEST(Aerodynamics, GroundEffectBoostsClNearGround) {
    ...
    a.update(makeAeroIn(angle_from_degrees(10.0), angle_from_degrees(0.0), 0.0, 100.0, 1.0, 1.0, 1000.0, 0.0, -1100.0, 100.0, 0.0), s_away);
    const double cl_away = s_away.cl;

    // Near ground (AGL = 3 ft, within 0.2*span = 6 ft)
    AeroState s_near = makeAero();
    a.update(makeAeroIn(angle_from_degrees(10.0), angle_from_degrees(0.0), 0.0, 100.0, 1.0, 1.0, 100.0, 0.0, -3.0, 100.0, 0.0), s_near);
...
TEST(Aerodynamics, GroundEffectFadesInTransitionZone) {
    ...
    a.update(makeAeroIn(angle_from_degrees(10.0), angle_from_degrees(0.0), 0.0, 100.0, 1.0, 1.0, 100.0, 0.0, -18.0, 100.0, 0.0), s_mid);
...
TEST(Aerodynamics, GroundEffectOffBeyondOneSpan) {
    ...
    a.update(makeAeroIn(angle_from_degrees(10.0), angle_from_degrees(0.0), 0.0, 100.0, 1.0, 1.0, 100.0, 0.0, -35.0, 100.0, 0.0), s_beyond);
...
TEST(Aerodynamics, TefBoostsCl) {
    ...
    s_no_tef.tefPos = 0.0;
    a.update(makeAeroIn(angle_from_degrees(10.0), angle_from_degrees(0.0), 0.0, 100.0, 1.0, 1.0, 1000.0, 0.0, -1100.0, 100.0, 0.0), s_no_tef);

    AeroState s_tef = makeAero();
    s_tef.tefPos = 1.0;
    a.update(makeAeroIn(angle_from_degrees(10.0), angle_from_degrees(0.0), 0.0, 100.0, 1.0, 1.0, 1000.0, 0.0, -1100.0, 100.0, 0.0), s_tef);
...
TEST(Aerodynamics, LefChangesCd) {
    ...
    a.update(makeAeroIn(angle_from_degrees(10.0), angle_from_degrees(0.0), 0.0, 100.0, 1.0, 1.0, 1000.0, 0.0, -1100.0, 100.0, 0.0), s_no_lef);

    AeroState s_lef = makeAero();
    s_lef.lefPos = 1.0;
    a.update(makeAeroIn(angle_from_degrees(10.0), angle_from_degrees(0.0), 0.0, 100.0, 1.0, 1.0, 1000.0, 0.0, -1100.0, 100.0, 0.0), s_lef);
...
TEST(Aerodynamics, SpeedBrakeAddsDrag) {
    ...
    a.update(makeAeroIn(angle_from_degrees(10.0), angle_from_degrees(0.0), 0.0, 100.0, 1.0, 1.0, 1000.0, 0.0, -1100.0, 100.0, 0.0), s_no_brake);

    AeroState s_brake = makeAero();
    s_brake.dbrake = 1.0;
    a.update(makeAeroIn(angle_from_degrees(10.0), angle_from_degrees(0.0), 0.0, 100.0, 1.0, 1.0, 1000.0, 0.0, -1100.0, 100.0, 0.0), s_brake);
...
TEST(Aerodynamics, GearAddsDrag) {
    ...
    a.update(makeAeroIn(angle_from_degrees(10.0), angle_from_degrees(0.0), 0.0, 100.0, 1.0, 1.0, 1000.0, 0.0, -1100.0, 100.0, 0.0), s_gear_up);

    AeroState s_gear_down = makeAero();
    s_gear_down.gearPos = 1.0;
    a.update(makeAeroIn(angle_from_degrees(10.0), angle_from_degrees(0.0), 0.0, 100.0, 1.0, 1.0, 1000.0, 0.0, -1100.0, 100.0, 0.0), s_gear_down);
...
TEST(Aerodynamics, StoresDragAddedToCd) {
    ...
    AeroState s = makeAero();
    s.cdStores = 0.15;
    a.update(makeAeroIn(angle_from_degrees(10.0), angle_from_degrees(0.0), 0.0, 100.0, 1.0, 1.0, 1000.0, 0.0, -1100.0, 100.0, 0.0), s);

    AeroState s_no_stores = makeAero();
    s_no_stores.cdStores = 0.0;
    a.update(makeAeroIn(angle_from_degrees(10.0), angle_from_degrees(0.0), 0.0, 100.0, 1.0, 1.0, 1000.0, 0.0, -1100.0, 100.0, 0.0), s_no_stores);
...
TEST(Aerodynamics, DragChuteAddsDragWhenDeployed) {
    ...
    a.update(makeAeroIn(angle_from_degrees(10.0), angle_from_degrees(0.0), 0.0, 100.0, 1.0, 1.0, 1000.0, 0.0, -1100.0, 100.0, 0.0), s_no_chute);

    AeroState s_chute = makeAero();
    s_chute.dragChutePos = 1.0;
    a.update(makeAeroIn(angle_from_degrees(10.0), angle_from_degrees(0.0), 0.0, 100.0, 1.0, 1.0, 1000.0, 0.0, -1100.0, 100.0, 0.0), s_chute);
...
TEST(Aerodynamics, DragChuteDoesNotDeployBelowHalfThreshold) {
    ...
    a.update(makeAeroIn(angle_from_degrees(10.0), angle_from_degrees(0.0), 0.0, 100.0, 1.0, 1.0, 1000.0, 0.0, -1100.0, 100.0, 0.0), s_zero);
...
TEST(Aerodynamics, FlatSpinZeroesLift) {
    ...
    a.update(makeAeroIn(angle_from_degrees(10.0), angle_from_degrees(0.0), 0.0, 100.0, 1.0, 10.0, 1000.0, 0.0, -1100.0, 100.0, 0.0), s);
...
TEST(Aerodynamics, ZeroAirspeedZeroesLift) {
    ...
    AeroState s = makeAero();
    a.update(makeAeroIn(angle_from_degrees(10.0), angle_from_degrees(0.0), 0.0, /*vt=*/0.0, 1.0, 1.0, 1000.0, 0.0, -1100.0, 100.0, 0.0), s);
    EXPECT_DOUBLE_EQ(s.lift, 0.0);
}
...
TEST(Aerodynamics, NormalFlightLiftIsClTimesQsom) {
    ...
    AeroState s = makeAero();
    a.update(makeAeroIn(angle_from_degrees(10.0), angle_from_degrees(0.0), 0.0, 100.0, 1.0, /*qsom=*/5.0, 1000.0, 0.0, -1100.0, 100.0, 0.0), s);
...
TEST(Aerodynamics, StallDetectionSetsStalledFlag) {
    ...
    a.update(makeAeroIn(angle_from_degrees(20.0), angle_from_degrees(0.0), 0.0, 100.0, 1.0, 5.0, 1000.0, 0.0, -1100.0, 100.0, 0.0), s);
...
TEST(Aerodynamics, NoStallWhenCriticalAoaIsZero) {
    ...
    AeroState s = makeAero();
    a.update(makeAeroIn(angle_from_degrees(30.0), angle_from_degrees(0.0), 0.0, 100.0, 1.0, 5.0, 1000.0, 0.0, -1100.0, 100.0, 0.0), s);
...
TEST(Aerodynamics, StabilityAxesLiftIsNegativeZ) {
    ...
    Aerodynamics a(&sa.table, &sa.geom, &sa.aux);
    AeroState s = makeAero();
    a.update(makeAeroIn(angle_from_degrees(10.0), angle_from_degrees(0.0), 0.0, 100.0, 1.0, 5.0, 1000.0, 0.0, -1100.0, 100.0, 0.0), s);
...
TEST(Aerodynamics, BodyAxesCombineLiftAndDragAtZeroAlpha) {
    ...
    Aerodynamics a(&sa.table, &sa.geom, &sa.aux);
    AeroState s = makeAero();
    a.update(makeAeroIn(angle_from_degrees(0.0), angle_from_degrees(0.0), 0.0, 100.0, 1.0, 5.0, 1000.0, 0.0, -1100.0, 100.0, 0.0), s);
...
TEST(Aerodynamics, BetaRotatesWindAxes) {
    ...
    Aerodynamics a(&sa.table, &sa.geom, &sa.aux);
    AeroState s = makeAero();
    a.update(makeAeroIn(angle_from_degrees(5.0), angle_from_degrees(10.0), 0.0, 100.0, 1.0, 5.0, 1000.0, 0.0, -1100.0, 100.0, 0.0), s);
