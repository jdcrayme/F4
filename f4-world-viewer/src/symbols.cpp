// f4-world-viewer/src/symbols.cpp
//
...
void ViewerApp::Impl::draw_symbol(SymbolKind kind, float sx, float sy,
                                   float size_px, const RlColor& fill,
                                   const RlColor& outline, bool filled) {
