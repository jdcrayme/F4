...
| Campaign host (the engine contract) | `CAMP_HOST_PLAN.md` | Draft v1 — HOST-1 (contract + `campaignd`) and HOST-2 (the typed event stream + JSONL journal + replay identity) shipped; CAMP-HOST-3/CMD/ATM/INIT/SCALE/DOM pending. |
