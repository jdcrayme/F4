...
| Campaign host (the engine contract) | `CAMP_HOST_PLAN.md` | Draft v1 — CAMP-HOST-1 ships with this patch (f4-campaign-api + EngineSessionHost + `campaignd`, 58 ctest cases); CAMP-CMD/ATM/INIT/SCALE/DOM pending. |
